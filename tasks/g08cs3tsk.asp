...
<form method="post">
      ...
      <td colspan="3" ><span class="taskblue">These documents all come from the 
        moment of change-over from the old system of constables and watchmen (see 
        Galleries Crime Prevention before 1450 and Crime Prevention 1450-1750) 
        to the new police. Use this table to compare the two crime prevention 
        systems.</span></td>
          </tr>
          <tr> 
            
      <td colspan="2" align="center"><img src="../prevention/g08/jpgs/task3.gif" width="188" height="282" alt="A watchman"></td>
            
      <td align="center"><img src="../prevention/g08/jpgs/task3b.gif" width="176" height="282" alt="Policemen"></td>
          </tr>
          <tr> 
            <td align="center">&nbsp;</td>
...
%>
          ...
          <tr> 
            <td><span class="taskblue">The old constables and watchmen: BAD points 
              </span></td>
            <td> <br>
          ...
          <tr> 
            <td><span class="taskblue">The new police:GOOD points </span></td>
            <td> <br>
          ...
          <tr> 
            <td><span class="taskblue">The new police:BAD points </span></td>
            <td> 
