    ...
    <tr align="center">
      <td valign="top">
        <table border="0" cellspacing="3" cellpadding="0" width="400">
          <tr valign="top">
            <td colspan="2" >
              <p class="tasktitlegreen">Case Study 1- Was it a crime to be poor?</p>
            </td>
          </tr>
          <tr valign="top">
            <td colspan="2" >&nbsp;</td>
          ...
          <tr>
            <td colspan="2" align="center" ><img src="../crime/g04/jpgs/task1.gif" alt="" width="131" height="250"></td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="2">
              <p class="taskgreen">Make two copies of this picture<br>
                <br>
                i. <br>
                On the first copy, write in the labels some of the words the government
                might use about this vagabond, who he is, what he is up to and
                what should be done with him.<br>
                ii. <br>
                On the other copy, write in some more sympathetic words which
                could be used to describe him and his situation.</p>
              <span class="taskgreen">Why had the government made it a crime to
              be poor?</span></td>
          </tr>
          <%
