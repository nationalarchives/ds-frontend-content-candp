...
Session("lc_appl_no") = 31  ' C&P: Crime
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" width="50%" bgcolor="#003300">&nbsp;</td>
    <td align="left" width="106" bgcolor="#003300">&nbsp;</td>
	<td align="right" width="12.5%" bgcolor="003300"><a href="../default.htm"><img src="../global/mpgreen.gif" width="84" height="30" border="0" alt="Main page"></a></td>
  </tr>
  <tr bgcolor="#FFFFFF">
  ...
  <table border="0" cellpadding="0" cellspacing="0">
	<tr>
	  <td align="left" valign="top" colspan="6">
		<p class="s_titlesm">CRIME: The Big Question</p>
		<p class="s_titlesm">Has crime really changed over time?</p>
		<p class="s_default">Choose some of these sources for your exhibition, and fill in the captions to explain how your source illustrates the point you are making in the panel.</p>
...
%>
		<tr>
		  <td bgcolor="#CDCDB6" colspan="6"><p class="s_default">You are signed in as <b><%= Session("lc_user_name") %></b>, and your work is
			being permanently saved. You can <a href="<%= Application("lc_sign_out_path") %>">sign out</a>
			and return to your work at a later date. <b>Remember to save your work before signing out!</b></p></td>
		</tr>
<%
	Else
%>
		<tr>
		  <td bgcolor="#CDCDB6" colspan="6"><p class="s_default">You are not signed in yet. You can work on this
			page, but it will not be saved when you leave this site. <a href="<%= Application("lc_sign_in_path") %>">Sign in now</a> to permanently save your work, or to retrieve any previous work you have saved before.</p></td>
		</tr>
<%
	End If
%>
	...
	<td bgcolor="#EBEBE2" align="left" valign="bottom" class="s_default" colspan="6">
		<br><p><b>Exhibition panels:</b></p>
		<ol>
			<li>CHANGE</li>
			<li>CONTINUITY</li>
			<li>FACTORS AFFECTING CRIME: GOVERNMENT</li>
			<li>OTHER FACTORS AFFECTING CRIME</li>
		</ol>
	</td>
	</tr>
	<tr>
		<td bgcolor="#CDCDB6" align="left" valign="bottom" class="s_default"><b><br>Source Title and Your Caption</b></td>
		<td bgcolor="#EBEBE2" colspan="5" align="center" valign="bottom" class="s_default"><b>Panel number</b></td>
	</tr>
	<tr valign="middle">
...
<%
	Set objLC = Server.CreateObject("NationalArchives.LearningCurve")
	' Get sources
	aSources = objLC.GetData("includes/cp-crime-data.txt", True, "cp_crime_data")
...
%>
	<tr valign="middle">
	  <td bgcolor="#CDCDB6" align="left">
		...
		<input type="submit" name="create" value="Create my exhibition">
	  </td>
...
Sub CreateExhibition
	' Retrieve and display existing sources stored under this session
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" width="50%" bgcolor="#003300">&nbsp;</td>
    <td align="left" width="106" bgcolor="#003300">&nbsp;</td>
    <td align="right" bgcolor="#003300"><a href="../default.htm"><img src="../global/mpgreen.gif" width="84" height="30" border="0" alt="Main page"></a></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="left" width="21%">&nbsp;</td>
    <td align="center" width="60%">&nbsp;</td>
...
<div id="exhibition">
<p class="s_titlesm">CHANGE AND CONTINUITY IN ENGLISH CRIME</p>

<!-- PANEL ONE -->
<div id="panel1">
<p class="s_titlesm">CHANGE</p>
<%= htmPanel(1) %>
</div>

<!-- PANEL TWO -->
<div id="panel2">
<p class="s_titlesm">CONTINUITY</p>
<%= htmPanel(2) %>
</div>

<!-- PANEL THREE -->
<div id="panel3">
<p class="s_titlesm">FACTORS AFFECTING CRIME: GOVERNMENT</p>
<%= htmPanel(3) %>
</div>

<!-- PANEL FOUR -->
<div id="panel4">
<p class="s_titlesm">OTHER FACTORS AFFECTING CRIME</p>
<%= htmPanel(4) %>
</div>
